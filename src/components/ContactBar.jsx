    ...
    return (
        <div className="flex flex-col justify-center bg-gray-700 md:flex-row contactbar ">
            <motion.div
                ...
                viewport={{ once: true }}
                className="box w-[80%] flex flex-col md:flex-row gap-16 p-10 text-white justify-center"
            >
                <motion.div variants={leftVariants} className="flex flex-col items-start flex-1 gap-5 applink">
                ...
                <motion.div variants={leftVariants} className="flex flex-col flex-1 gap-2 help-centre">
                    <div className="font-bold heading">
                        <h5>Help Centre </h5>
                        <hr className="w-10 h-0.5 bg-red-500 border-0" />
                    </div>
                ...
                <motion.div variants={rightVariants} className="flex flex-col flex-1 gap-2 leading-7 contact-us text-wrap">
                    <div className="font-bold heading">
                        <h5>Contact Us </h5>
                        <hr className=" w-10 h-0.5 bg-red-500 border-0" />
                    </div>
                ...
                <motion.div variants={rightVariants} className="flex-1 socials ">
                    <div className="font-bold heading">
